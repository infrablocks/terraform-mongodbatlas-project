...
namespace :keys do
  ...
  namespace :gpg do
    RakeGPG.define_generate_key_task(
        ...
        owner_comment: 'terraform-mongodbatlas-project CI Key')
  end
end

RakeCircleCI.define_project_tasks(
    namespace: :circle_ci,
    project_slug: 'github/infrablocks/terraform-mongodbatlas-project'
) do |t|
  circle_ci_config =
...
RakeGithub.define_repository_tasks(
    namespace: :github,
    repository: 'infrablocks/terraform-mongodbatlas-project',
) do |t|
  github_config =
